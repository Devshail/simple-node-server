...
var infoStream = fs.createWriteStream("logs/info.log");
...
// file if needed.
var errorStream = fs.createWriteStream("logs/error.log");
...
var debugStream = fs.createWriteStream("logs/debug.log");
...
// iso string and a \n newline character
Logger.info = function(msg,filename=null) {
    var message = new Date().toISOString() + " :filename"+filename+": " + msg + "\n";
    infoStream.write(message);
};

Logger.debug = function(msg,filename) {
  var message = new Date().toISOString() + " :filename"+filename+": " + msg + "\n";
  debugStream.write(message);
};

Logger.error = function(msg,filename) {
  var message = new Date().toISOString() + " :filename"+filename+": " + msg + "\n";
